...
const coloresLote = ["#facc15", "#60a5fa", "#22c55e", "#f87171", "#a78bfa"];
...
const DashboardPage = () => {
	...
	return (
		<div className="p-4 min-h-screen bg-secondary">
			...
			<div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
				{/* Gráfica de Pedidos */}
						...
						<div className="space-y-3">
							{ultimosLotes.map((lote) => (
								...
								>
									<div className="w-10 h-10 bg-primary rounded-full  flex items-center justify-center text-white font-bold">
										{lote.NombreCliente
											? lote.NombreCliente.charAt(0).toUpperCase()
											: "C"}
									</div>
									<div className="flex-1">
