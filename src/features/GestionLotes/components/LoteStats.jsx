...
export default function LoteStats({ lotes }) {
	...
	const stats = {
		total: lotes.length,
		pendientes: lotes.filter((l) => l.Estado?.toLowerCase() === "pendiente")
			.length,
		enProceso: lotes.filter((l) => l.Estado?.toLowerCase() === "en proceso")
			.length,
		certificados: lotes.filter((l) => l.Estado?.toLowerCase() === "certificado")
			.length,
		completados: lotes.filter((l) => l.Estado?.toLowerCase() === "completado")
			.length,
		noCertificados: lotes.filter(
			(l) => l.Estado?.toLowerCase() === "no certificado"
		).length,
	};
