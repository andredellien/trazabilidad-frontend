...
export default function Sidebar({ onCollapse }) {
	...
	const groupedLinks = [
		...
		},
		{
			...
			links: [
				{
					to: "/materia-prima-base",
					label: "Materias Prima Base",
					icon: <FiPackage />,
				},
				{
					to: "/solicitar-materia-prima",
					label: "Solicitar Materias Prima",
					icon: <FiPackage />,
				},
				{
					to: "/recepcion-materia-prima",
					label: "Recepcion Materias Prima",
					icon: <FiPackage />,
				},
				{
					to: "/proveedores",
		...
		{
			title: "Lote",
			links: [{ to: "/gestion-lotes", label: "Lotes", icon: <FiBox /> }],
		},
		{
			title: "Procesos",
			links: [
				...
				{
					to: "/variables-estandar",
					label: "Variables Estandar",
					icon: <FiTool />,
					admin: true,
				},
		...
		},
		{
			...
			links: [
				...
				{
					to: "/lotes-almacenados",
					label: "Lotes almacenados",
					icon: <FiList />,
				},
			],
		},
		...
		<>
			...
			<aside
				style={{
					...
					color: "white",
					height: "100vh",
					padding: isMobile ? "4rem 0.5rem 1rem 0.5rem" : "1rem 0.5rem",
					overflowY: "auto",
			...
			>
											...
											{visibleLinks.map((link) => (
												<Link
													...
													style={{
														...
														textDecoration: "none",
														background:
															pathname === link.to ? "#005f4f" : "transparent",
														borderRadius: "6px",
														margin: "0.3rem 0",
													}}
												>
				...
				<div
					style={{ marginTop: "auto", padding: collapsed ? "0.5rem" : "1rem" }}
				>
					<button
						onClick={logout}
